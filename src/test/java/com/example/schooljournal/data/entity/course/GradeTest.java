...
class GradeTest {
     ...
     *
     * <ul>
     *   <li>default or parameterless constructor of {@link Grade}
     *   <li>{@link Grade#setCourse(Course)}
     *   <li>{@link Grade#setGrade(int)}
     *   <li>{@link Grade#setStudent(Student)}
     *   <li>{@link Grade#getCourse()}
     *   <li>{@link Grade#getGrade()}
     *   <li>{@link Grade#getStudent()}
     * </ul>
     */
    @Test
    void testGettersAndSetters() {
        // Arrange and Act
        Grade actualGrade = new Grade();
        ...
        actualGrade.setCourse(course);
        actualGrade.setGrade(1);
        ...
        actualGrade.setStudent(student);
        Course actualCourse = actualGrade.getCourse();
        int actualGrade2 = actualGrade.getGrade();

        // Assert that nothing has changed
        assertEquals(1, actualGrade2);
        assertSame(course, actualCourse);
        assertSame(student, actualGrade.getStudent());
    }
}
