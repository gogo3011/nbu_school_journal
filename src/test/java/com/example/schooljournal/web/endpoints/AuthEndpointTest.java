...
@ContextConfiguration(classes = {AuthEndpoint.class})
...
class AuthEndpointTest {
    ...
    /**
     * Method under test: {@link AuthEndpoint#currentUser()}
     */
    @Test
    void testCurrentUser() throws Exception {
        ...
        // Act
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(authEndpoint).build().perform(requestBuilder);
    ...
    /**
     * Method under test:
     * {@link AuthEndpoint#login(User, HttpServletRequest, HttpServletResponse)}
     */
    @Test
    ...
    /**
     * Method under test: {@link AuthEndpoint#registerUser(User)}
     */
    @Test
